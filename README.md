...
ภาพข้างล่างต่อไปนี้จะเป็นการเปรียบเทียบการทำงานของคอมพิวเตอร์ในรูปแบบปกติและ Pipelining

![pipe1](https://cs.stanford.edu/people/eroberts/courses/soco/projects/risc/pipelining/laundry1.gif)

จากภาพข้างบนเป็นการเปรียบเทียบการทำงานของคอมพิวเตอร์ในรูปแบบปกติ กล่าวคือ เราให้กองเสื้อผ้าฝั่งซ้ายมือเป็นคำสั่ง จากภาพจะพบว่า เราทำการซักผ้ากอง A แล้วนำไปปั่นแห้งเสร็จจึงจะนำผ้า กอง B มาซักต่อ สามารถอธิบายได้ว่า กว่าที่เราจะทำคำสั่งต่อไปได้นั้นเราต้องทำคำสั่งก่อนหน้าให้เสร็จสมบูรณ์ก่อนถึงจะเริ่มทำคำสั่งถัดไปได้ ซึ่งทำให้ใช้เวลาจำนวนมาก

![pipe2](https://cs.stanford.edu/people/eroberts/courses/soco/projects/risc/pipelining/laundry2.gif)

จากภาพนี้แสดงใหเห็นถึงการทำงานลักษณะ Pipelining กล่าวคือ เมื่อเรานำกองเสื้อผ้า A ไปเข้าเครื่องซักผ้าเสร็จแล้วจะทำให้เครื่องซักผ้านั้นว่าง เราสามารถนำกองเสื้อผ้า B ไปเข้าเครื่องซักผ้าต่อได้เลย โดยไม่ต้องรอให้ กองเสื้อผ้า A ปั่นแห้งเสร็จ สามารถอธิบายได้ว่า การที่เราทำคำสั่ง A เสร็จในขั้นตอนใดๆขั้นตอนนึง เราสามารถนำ คำสั่งถัดไปมาดำเนินการต่อได้เลย ซึ่งจะเป็นการประหยัดเวลาในการทำงาน

### งานครั้งที่ 7
  [คลิปงานครั้งที่ 7 Pipelining](https://www.youtube.com/watch?v=NQ4u19d90rE&t=1s)
